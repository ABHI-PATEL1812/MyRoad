...
public class Assam extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase.getInstance().getReference("e2tlUwRxGeX0iAHO5lY8HsiIRjX2").child("Accident").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                final int sizea=(int)dataSnapshot.getChildrenCount();
                FirebaseDatabase.getInstance().getReference("e2tlUwRxGeX0iAHO5lY8HsiIRjX2").child("Land Slides").addValueEventListener(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        final int sizeb=(int)dataSnapshot.getChildrenCount();
                        FirebaseDatabase.getInstance().getReference("e2tlUwRxGeX0iAHO5lY8HsiIRjX2").child("Road Damage").addValueEventListener(new ValueEventListener() {
                            @Override
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                FirebaseDatabase.getInstance().getReference("e2tlUwRxGeX0iAHO5lY8HsiIRjX2").child("Road Damage").addValueEventListener(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                        ...
                                        FirebaseDatabase.getInstance().getReference("e2tlUwRxGeX0iAHO5lY8HsiIRjX2").child("Other").addValueEventListener(new ValueEventListener() {
                                            @Override
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
