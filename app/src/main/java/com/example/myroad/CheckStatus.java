...
public class CheckStatus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent=new Intent(getApplicationContext(),UserComplaint.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event)
    {
        ...
        {
            startActivity(new Intent(CheckStatus.this,HomePage.class));
            finish();
        }
    ...
    protected void onStart() {
        ...
        db.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                ComplaintList adapter =new ComplaintList(CheckStatus.this,complaintlist);
